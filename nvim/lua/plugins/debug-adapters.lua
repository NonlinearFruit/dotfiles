local function key_mappings()
  ...
  keymap("<S-f5>", "lua require('dap').run_to_cursor()", "Continue execution until it reaches the cursor")
  ...
  end, { desc = "Go to['] point of [e]xecution/[e]xplosion" })
  vim.keymap.set("n", "[f", function()
    require("dap").up()
  end, { desc = "Go up [[] a [f]rame" })
  vim.keymap.set("n", "]f", function()
    require("dap").down()
  end, { desc = "Go down []] a [f]rame" })
